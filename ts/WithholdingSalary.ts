...
export class WithholdingSalary
{
  ...
  // 源泉徴収における給与所得控除額を求める
  // 電子計算機等を使用して源泉徴収税額を計算する方法（令和4年分）別表第一
  ...
  // 源泉徴収における基本控除額を求める
  // 電子計算機等を使用して源泉徴収税額を計算する方法（令和4年分）別表第三
  // https://www.nta.go.jp/publication/pamph/gensen/zeigakuhyo2021/data/18.pdf
  ...
  // 電子計算機等を使用して源泉徴収税額を計算する方法（令和4年分）別表第二
  // https://www.nta.go.jp/publication/pamph/gensen/zeigakuhyo2021/data/18.pdf
  ...
  // 源泉徴収額を求める
  // 電子計算機等を使用して源泉徴収税額を計算する方法（令和4年分）別表第四
  // https://www.nta.go.jp/publication/pamph/gensen/zeigakuhyo2021/data/18.pdf
